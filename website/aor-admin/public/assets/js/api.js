...
const AdminApi = (() => {
  ...
  return {
    ...
    getDashboardStaleReports: () => getJson("/api/dashboard/stale-reports"), // Phase58 STEP7
    getDashboardRemediationPlan: () => getJson("/api/dashboard/remediation-plan"), // Phase58 STEP8
