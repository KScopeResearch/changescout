...
async function checkDashboardSmoke() {
  ...
  try {
    ...
    // Phase59: Operational Health Detail API（read-only）の疎通。
    const dashOpHealthApi = await httpGet("localhost", port, "/api/dashboard/operational-health", { auth: `${adminUser}:${adminPassword}` });
...
const COVERAGE_MAP = [
  ...
  { module: "website/aor/assets/js/summary-guard.js", testFile: "summary-guard.test.js" },
  { module: "website/aor/assets/js/market-stats.js", testFile: "market-stats.test.js" },
  { module: "website/aor/assets/js/preview-ui.js", testFile: "preview-ui.test.js, hero-variant.test.js, benefit-card.test.js, trust-section.test.js, market-snapshot.test.js, business-chance-copy.test.js" },
  { module: "website/aor/assets/js/illustrations.js", testFile: "visual-theme.test.js, business-chance-copy.test.js" },
  { module: "website/aor/assets/js/report-preview.js", testFile: "report-preview-static.test.js, hero-layout.test.js, business-chance-copy.test.js（静的アサーション）" },
